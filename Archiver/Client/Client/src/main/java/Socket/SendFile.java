...
public class SendFile implements Runnable {
     ...
     */
    public SendFile(Socket socket,String path_to_file, String fileLength,String fileName, String lastModification){
        this.socket = socket;
    ...
    public void run() {
           try {
               ...
               if(code.equals("210")) {
                   ...
                   String flag = "true";//---------->UWAGA - MA BYC POBIERANE Z OKNA WYBORU, GDY KLIENT WYBEIRA CZY CHCE WYSLAC JEDNAK CZY NIE <----------------------
